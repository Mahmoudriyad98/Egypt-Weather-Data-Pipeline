        ...
        create or replace transient table EGYPT_WEATHER_DB.gold.fact_air_pollution
         as
        (
...
WITH air_pollution_data AS (
    ...
    FROM EGYPT_WEATHER_DB.silver.silver_air_pollution ap
...
SELECT
    ROW_NUMBER() OVER (ORDER BY DATETIME, GOVERNORATE) AS AIR_POLLUTION_KEY,
    GOVERNORATE_KEY,
    DATE_KEY,
    DATETIME,
    HOUR_OF_DAY,
