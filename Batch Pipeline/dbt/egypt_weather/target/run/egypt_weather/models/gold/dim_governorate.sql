        ...
        create or replace transient table EGYPT_WEATHER_DB.gold.dim_governorate
         as
        (

WITH all_governorates AS (
    SELECT DISTINCT GOVERNORATE FROM EGYPT_WEATHER_DB.silver.silver_air_pollution
    UNION
    SELECT DISTINCT GOVERNORATE FROM EGYPT_WEATHER_DB.silver.silver_solar_energy
    UNION
    SELECT DISTINCT GOVERNORATE FROM EGYPT_WEATHER_DB.silver.silver_weather
)
